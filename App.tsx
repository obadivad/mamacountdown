...
const App: React.FC = () => {
  ...
  return (
    <div className={`relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden select-none ${stage === 'party' ? 'animate-strobe' : 'bg-black'}`}>
      ...
      <main className="relative z-30 flex flex-col items-center justify-center w-full h-full pb-[5vh]">
        ...
        {/* 1. MAMA LOGO (Top) */}
        <div className={`relative z-20 transform-gpu transition-opacity duration-500 ${stage === 'overdrive' ? 'opacity-0' : 'opacity-100'}`}>
           <MamaLogo />
        </div>
          ...
          <div className="absolute inset-0 w-full h-full flex flex-col items-center justify-center z-50">
            ...
            <div className="relative z-40 text-center flex flex-col items-center justify-center space-y-[2vh]">
              <div className="flex flex-col items-center leading-none">
                <span className="text-[5vw] text-white font-black italic tracking-widest animate-slam" style={{ animationDelay: '0.1s', fontFamily: "'Montserrat', sans-serif" }}>MAMA</span>
                <span className="text-[4vw] text-white font-bold tracking-[1em] animate-slam" style={{ animationDelay: '0.2s', fontFamily: "'Montserrat', sans-serif" }}>WISHES YOU A</span>
                
                <div className="flex items-center space-x-6 my-[2vh]">
                   <span className="text-[8vw] text-emerald-400 font-black italic animate-slam animate-text-party" style={{ animationDelay: '0.4s', fontFamily: "'Bungee', cursive", textShadow: '5px 5px 0px #000' }}>HAPPY</span>
                   <span className="text-[4vw] text-white font-black animate-slam" style={{ animationDelay: '0.5s' }}>&</span>
                   <span className="text-[8vw] text-pink-500 font-black italic animate-slam animate-text-party" style={{ animationDelay: '0.6s', fontFamily: "'Bungee', cursive", textShadow: '5px 5px 0px #000' }}>NAUGHTY</span>
                </div>
              ...
              {[...Array(50)].map((_, i) => (
                <div 
                  ...
                  style={{
                    ...
                    backgroundColor: ['#ff00cc', '#3333ff', '#00d4ff', '#ff00cc'][Math.floor(Math.random() * 4)]
                  }}
                />
              ))}
            </div>
